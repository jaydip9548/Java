...
class DES1 {
    ...
    public static void main(String args[]) throws UnsupportedEncodingException {
        ...
        String output = "";
        String text = "";
        for (int i = 0; i < text1.length(); i += 16) {

            text = cipher.encrypt(text1.substring(i, i + 16), key);
            output += text;
        }
...
//  Encrypted hex text
        ...
        for (int i = 0; i < output.length(); i += 16) {
            ...
            text = cipher.decrypt(output.substring(i, i + 16), key);
            dec += text;
        }
